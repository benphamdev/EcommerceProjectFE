...
import { navigation } from "../../../ecommerce-products-data/navigation";
...
export default function Navigation() {
    ...
    const handleCategoryClick = (category, section, item, closeDialog) => {
    ...
    return (
        <div className="bg-white">
            ...
            <Transition.Root show={open} as={Fragment}>
                <Dialog as={"div"} onClose={setOpen} className="relative z-50 lg:hidden">
                    <Transition.Child>
                        as={"fragment"}
