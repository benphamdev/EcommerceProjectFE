...
import { filters, singleFilter, sortOptions } from "../../../../shared/utils/FilterData";
...
export default function Product() {
    ...
    const handleRadioFilter = (value, id) => {
        if (value === 'REMOVE') {
            navigate('/')
            return;
        }
                        ...
                        <div className="grid grid-cols-1 gap-x-8 gap-y-10 lg:grid-cols-5">
                            ...
                            <div>
                                ...
                                <div className={'flex items-center justify-between'}>
                                    <h1 className={'opacity-60 text-lg font-bold'}>Filter</h1>
                                    <FilterAltIcon/>
                                </div>
                                    ...
                                    {filters.map((section) => (
                                        <Disclosure key={section.id} as="div" className="border-b border-gray-200 py-6">
                                            <h3 className="-my-3 flow-root">
                                                <DisclosureButton
                                                    className="group flex w-full items-center justify-between bg-white
                                                    py-3 text-sm text-gray-400 hover:text-gray-500">
                                                    <span className="font-medium text-gray-900">{section.name}</span>
                                                    <span className="ml-6 flex items-center">
                          <PlusIcon aria-hidden="true" className="h-5 w-5 group-data-[open]:hidden"/>
                          <MinusIcon aria-hidden="true" className="h-5 w-5 [.group:not([data-open])_&]:hidden"/>
                                            ...
                                            {({ open }) => (
                                                <>
                                                    ...
                                                    bg-white py-3 text-sm text-gray-400 hover:text-gray-500"
                                                            onClick={() => handleRadioFilter('REMOVE', section.id)}
                                                        >
                                                            <span
